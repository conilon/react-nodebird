...
const ImagesZoom = ({ images, onClose }) => {
    ...
    return (
        <div style={{ position: 'fixed', zIndex: 5000, top: 0, left: 0, rihgt: 0, bottom: 0 }}>
            ...
            <div style={{ height: 'calc(100% - 44px)', background: '#090909' }}>
                <div>
                    ...
                    >
                        {images.map((v) => (
                            <div key={v.id} style={{ padding: 32, textAlign: 'center' }}>
                                <img src={`http://localhost:3065/${v.src}`} alt="example" style={{ margin: '0 auto', maxHeight: 750 }} />
                            </div>
                        ))}
                    </Slick>
